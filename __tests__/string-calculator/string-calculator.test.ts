...
describe('String Calculator', () => {
  ...
  it('allows multiple delimiters with more than one character wrapped by brackets', () => {
    const THREE_ATS = '@@@';
    const SIX_DOLLARS = '$$$$$$';
    const values = `//[${THREE_ATS}][${SIX_DOLLARS}]\n1${THREE_ATS}2${SIX_DOLLARS}3${THREE_ATS}4`;
